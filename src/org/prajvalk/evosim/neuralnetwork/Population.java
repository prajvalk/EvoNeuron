...
public class Population {
    ...
    public void naturalSelection() {
        ...
        for (int j = 0; j < species.size(); j++) {//for each species
            ...
            int NoOfChildren = (int) (floor(species.get(j).averageFitness/averageSum * pop.size()) -1);//the number of children this species is allowed, note -1 is because the champ is already added
